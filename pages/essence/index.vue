  ...
  <main>
    <section class="section hero">
      ...
      <div class="hero__cards" ref="cardsContainer">
        <Card
          customClass="hero__cards-item"
          v-for="(card, index) in cards"
          :title="card.title"
          :img="card.img"
          :imgBrown="card.reversed.imgBrown"
          :text="card.text"
          :key="index"
...
import sun from "@/assets/imgs/essence/icons/sun.svg";
import sunBrown from "@/assets/imgs/essence/icons/sunBrown.svg";
import drops from "@/assets/imgs/essence/icons/drops.svg";
import dropsBrown from "@/assets/imgs/essence/icons/dropsBrown.svg";
import climat from "@/assets/imgs/essence/icons/climat.svg";
import climatBrown from "@/assets/imgs/essence/icons/climatBrown.svg";
import nature from "@/assets/imgs/essence/icons/nature.svg";
import natureBrown from "@/assets/imgs/essence/icons/natureBrown.svg";
import soil from "@/assets/imgs/essence/icons/soil.svg";
import soilBrown from "@/assets/imgs/essence/icons/soilBrown.svg";
...
const cards = [
  {
    ...
    reversed: {
      title: "Helios — <br />greek god of <br />the sun",
      img: helios,
      imgBrown: sunBrown,
      width: 42.133,
      height: 57.333,
