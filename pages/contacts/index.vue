<template>
  <main>
    <div class="map">
      <GoogleMap
        class="map-google"
        api-key="AIzaSyC8EUo71C7QErUV_wMJ1Pax2aRqgz7jDSk"
        :center="center"
        :zoom="10"
    ...
    <div class="info">
      ...
      <div class="info__distribution">
        <div class="info__distribution-title caption">Distribution issues</div>
...
const center = ref({});
onMounted(() => {
  // if (isDesktopStateStore.getIsDesktop) {
  center.value = { lat: 35.091402, lng: 25.161928 };
  // } else {
  //   center.value = { lat: 34.83567, lng: 24.914848 };
  // }
...
const infoList = [
  ...
  {
    text: "Telephone: <a href='tel:+306939508953'>+30 693 950 8953</a> <br />E’mail: info@greeklegend.gr",
    isTextGrotesk: false,
  },
  {
